                    ...
                    <div class="m-4">
                        ...
                        <div class="row gy-3 mb-4">
                            ...
                            <div class="col-lg-2 col-sm-6 col-6 d-flex flex-row flex-lg-column flex-xl-row text-nowrap">
                                <div class="">
                                    <select style="width: 100px;" class="form-select me-4" autocompleted="">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                ...
                <div class="card shadow-0 border">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="/product" class="btn btn-light w-100 border mt-2"> Back to shop </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card px-4 border shadow-0">
                    ...
                    <a href="#" class="">
                        <img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/9.webp"
                            class="card-img-top rounded-2">
                    </a>
                    <div class="card-body d-flex flex-column pt-3 border-top">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card px-4 border shadow-0">
                    ...
                    <a href="#" class="">
                        <img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/10.webp"
                            class="card-img-top rounded-2">
                    </a>
                    <div class="card-body d-flex flex-column pt-3 border-top">
